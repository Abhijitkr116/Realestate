...
function Navbar() {
    ...
    return (
        <div className='absolute w-full top-0 left-0 z-10'>
            <div className='bg-transparent container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32'>
                <img src={assets.logo} alt="" />
                <ul className='flex text-white hidden md:flex gap-7'>
